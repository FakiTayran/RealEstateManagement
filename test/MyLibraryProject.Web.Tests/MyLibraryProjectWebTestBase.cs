...
{
    public abstract class MyLibraryProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyLibraryProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyLibraryProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyLibraryProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyLibraryProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyLibraryProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyLibraryProjectDbContext, Task<T>> func)
        {
            T result;
